...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-bg-tertiary text-text-primary hover:bg-bg-border focus:ring-bg-border',
    outline: 'border border-bg-border text-text-primary hover:bg-bg-tertiary focus:ring-bg-border',
    ghost: 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary focus:ring-bg-border',
